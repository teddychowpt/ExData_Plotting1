...
## 2) "result_data" is another data frame used to store the processed result data for making a line plot. 
##
#############################################################################################################
...
#############################################################################################################
##
## Plot a line plot by using the data of Global_active_power (stored in the "result_data") with line in black.
...
plot( result_data$Date, result_data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)", bg = "transparent" )
